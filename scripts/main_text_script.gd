...
func _ready():
	...
	jensenConversationNode.set_conversation_options(jensenNodeA, jensenNodeB, jensenNodeC, jensenNodeD, conversationNodeHub)
	jensenNodeA.set_conversation_options(jensenNodeA, jensenNodeB, jensenNodeC, jensenNodeD, conversationNodeHub)
	jensenNodeB.set_conversation_options(jensenNodeA, jensenNodeB, jensenNodeC, jensenNodeD, conversationNodeHub)
	jensenNodeC.set_conversation_options(jensenNodeA, jensenNodeB, jensenNodeC, jensenNodeD, conversationNodeHub)
	jensenNodeD.set_conversation_options(jensenNodeA, jensenNodeB, jensenNodeC, jensenNodeD, conversationNodeHub)
	...
	petrovConversationNode.set_conversation_options(petrovNodeA, petrovNodeB, petrovNodeC, petrovNodeD, conversationNodeHub)
	petrovNodeA.set_conversation_options(petrovNodeA, petrovNodeB, petrovNodeC, petrovNodeD, conversationNodeHub)
	petrovNodeB.set_conversation_options(petrovNodeA, petrovNodeB, petrovNodeC, petrovNodeD, conversationNodeHub)
	petrovNodeC.set_conversation_options(petrovNodeA, petrovNodeB, petrovNodeC, petrovNodeD, conversationNodeHub)
	petrovNodeD.set_conversation_options(petrovNodeA, petrovNodeB, petrovNodeC, petrovNodeD, conversationNodeHub)
	...
	wuConversationNode.set_conversation_options(wuNodeA, wuNodeB, wuNodeC, wuNodeD, conversationNodeHub)
	wuNodeA.set_conversation_options(wuNodeA, wuNodeB, wuNodeC, wuNodeD, conversationNodeHub)
	wuNodeB.set_conversation_options(wuNodeA, wuNodeB, wuNodeC, wuNodeD, conversationNodeHub)
	wuNodeC.set_conversation_options(wuNodeA, wuNodeB, wuNodeC, wuNodeD, conversationNodeHub)
	wuNodeD.set_conversation_options(wuNodeA, wuNodeB, wuNodeC, wuNodeD, conversationNodeHub)
